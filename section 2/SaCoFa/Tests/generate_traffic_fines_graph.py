...
def main():
    output_dir = 'c:/Users/ferru/Desktop/tesi_con_maggi_materiale/traffic_fines_out/'
    results_file = os.path.join(output_dir, 'results_all_logs_avg.csv')
    ...
    original_log_df = data[data['Log'] == 'traffic_fines.xes']

    if original_log_df.empty:
        print("No matching rows found for 'traffic_fines.xes' in the Log column.")
        return
