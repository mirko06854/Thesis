...
def main():
    output_dir = 'c:/Users/ferru/Desktop/tesi_con_maggi_materiale/CoSeLog_out/more_threshold_tests_evaluation/'
    ...
    original_log_df = data[data['Log'] == 'CoSeLoG.xes']

    if original_log_df.empty:
        print("No matching rows found for 'CoSeLoG.xes' in the Log column.")
        return
