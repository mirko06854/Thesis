...
def main():
    output_dir = 'c:/Users/ferru/Desktop/tesi_con_maggi_materiale/BPI_Challenge_2012_out/'
    results_file = os.path.join(output_dir, 'result.csv')
    ...
    original_log_df = data[data['Log'] == 'BPI_Challenge_2012.xes']

    if original_log_df.empty:
        print("No matching rows found for 'BPI_Challenge_2012.xes' in the Log column.")
        return
