...
def main():
    output_dir = 'c:/Users/ferru/Desktop/tesi_con_maggi_materiale/help_desk_out/'
    ...
    original_log_df = data[data['Log'] == 'help_desk.xes']

    if original_log_df.empty:
        print("No matching rows found for 'help_desk.xes' in the Log column.")
        return
